...
import ru.learnhub.spring.boot.guess_springboot.service.MyService;
...
//		ApplicationContext applicationContext=new ClassPathXmlApplicationContext("config.xml");
		MyService beanMyService=context.getBean(MyService.class);
		beanMyService.saySomething();
		beanMyService.sayOtherthing();
